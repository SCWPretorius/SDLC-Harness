...
<!-- Generated from .github/agents/ado-planner.agent.md — run: node bin/sync-opencode-agents.mjs -->
...
7. Invoke via Task / @mention `ado-ops` (activate + branch) — do not send users to `implementer` without IDs.
