...
<!-- Generated from .github/agents/ado-ops-economy.agent.md — run: node bin/sync-opencode-agents.mjs -->
...
2. invoke via Task **`ado-planner-economy`** (Create backlog first) so Epic → Feature → Story → Task are created.
