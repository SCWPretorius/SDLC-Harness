...
<!-- Generated from .github/agents/tech-pm-economy.agent.md — run: node bin/sync-opencode-agents.mjs -->
...
5. Invoke via Task / @mention **`ado-planner-economy`** with the confirmed slices + AC in the prompt so work items are **created** in Azure DevOps (mandatory when none exist).
